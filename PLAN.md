...
## Shipped (latest)
- 2026-02-01: Working copy editing (revisions are immutable) + safe navigation prompts for uncommitted edits + print/PDF export without popups.

## Next to ship
- Editor flow: autosave snapshots and/or a “stash” for uncommitted edits
- History ergonomics: pin/star revisions; quick compare presets
